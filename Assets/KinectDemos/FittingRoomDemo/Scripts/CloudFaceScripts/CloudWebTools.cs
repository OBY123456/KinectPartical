...
public class CloudWebTools 
{
	...
	public static int GetStatusCode(UnityWebRequest request)
	{
		int status = -1;

		//if(request != null && request. != null && request.responseHeaders.ContainsKey("STATUS"))
		//{
	...
	/// <param name="request">Web request.</param>
	public static bool IsErrorStatus(UnityWebRequest request)
	{
	...
	/// <param name="request">Web request.</param>
	public static string GetStatusMessage(UnityWebRequest request)
	{
